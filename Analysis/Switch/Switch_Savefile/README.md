...
**This is an article discusses the Nintendo Switch save file structure.**
...
Changing the structure of the save file to a pattern that can be used in ImHex[^2] is as follows. 
