// source : https://github.com/libmtp/libmtp/blob/master/examples/pathutils.c#L130
#ifndef __PATHUTILS_HPP_
#define __PATHUTILS_HPP_
...
LIBMTP_filetype_t GuessFiletypeByExtension(const std::filesystem::path& file_path)
{
    const char* ptype = file_path.extension().c_str() + 1;
